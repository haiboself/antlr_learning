...
public interface SqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#queryToDesc}.
	 * @param ctx the parse tree
	 */
	void enterQueryToDesc(SqlBaseParser.QueryToDescContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#queryToDesc}.
	 * @param ctx the parse tree
	 */
	void exitQueryToDesc(SqlBaseParser.QueryToDescContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#ansiReserved}.
	 * @param ctx the parse tree
	 */
	void enterAnsiReserved(SqlBaseParser.AnsiReservedContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#ansiReserved}.
	 * @param ctx the parse tree
	 */
	void exitAnsiReserved(SqlBaseParser.AnsiReservedContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#defaultReserved}.
	 * @param ctx the parse tree
	 */
	void enterDefaultReserved(SqlBaseParser.DefaultReservedContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#defaultReserved}.
	 * @param ctx the parse tree
	 */
	void exitDefaultReserved(SqlBaseParser.DefaultReservedContext ctx);
	/**
