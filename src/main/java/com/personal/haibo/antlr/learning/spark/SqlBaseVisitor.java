...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#queryToDesc}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQueryToDesc(SqlBaseParser.QueryToDescContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#ansiReserved}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnsiReserved(SqlBaseParser.AnsiReservedContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#defaultReserved}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDefaultReserved(SqlBaseParser.DefaultReservedContext ctx);
	/**
